...
图表生成器production environment consists of the following services:
...
```bash
docker exec deepdiagram-db pg_dump -U postgres 图表生成器> backup.sql
```
